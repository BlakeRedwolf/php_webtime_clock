          ...
          <div class="table-responsive">
            ...
            <thead>
              ...
              <thead>
                <tr>
                  <th>Dates & Times</th>
                  <p>Choose the way dates and times are displayed throughout the application:</p>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>calender_style:</td>
                  <td>US</td>
                  <td>Default='US'</td>
                </tr>
                <tr>
              ...
              <thead>
                <tr>
                  ...
                  <p>Choose the way the hours worked report is formatted. The default settings can be changed when the report is run.</p>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>round_time:</td>
                  <td>0</td>
                  <td>Choose how to round up the time worked Default='0' (No round up)</td>
                </tr>
                <tr>
                  <td>datefmt:</td>
                  <td>n/j/y</td>
